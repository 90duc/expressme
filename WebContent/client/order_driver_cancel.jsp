	...
	<div class="warp">
		<div class="warp_form">
			...
			<div class="cancel_order">
				<button id="noBtn" class="button_w_h"
					value="cancelorder.do?id=${order.ID}&state=${order.orderStateE}">拒绝</button>
				<button id="yesBtn" class="button_w_h"
					value="confirmorder.do?id=${order.ID}&state=${order.orderStateE}">同意</button>
			</div>
		</div>
		...
		<div class="cancel_sure_box">
			<div class="cancel_sure">
				...
				<p>
					确定<span id="cancel_type"></span>？
				</p>
				<div class="sure_btns">
					<button id="cancel_no">否</button>
					&nbsp;&nbsp;&nbsp;&nbsp;
					<button id="cancel_yes">是</button>
				</div>
			</div>
		</div>
	</div>
</body>
<script src="js/dd_cancel.js"></script>
