...
import java.util.regex.Pattern;  
   ...
   public class IDCard {
        ...
        private static final String CHECKED_KEY_ERROR = "身份证校验码无效，不是合法的身份证号码";
		private static final String LOC_ERROR = "身份证地区编码错误。";
		private static final String DAY_ERROR = "身份证日期无效";
		private static final String MONTH_ERROR = "身份证月份无效";
		private static final String BIRTHDAY_ERROR = "身份证生日不在有效范围。";
		private static final String DATE_ERROR = "身份证出生日期无效。";
		public static final String NUMBER_KEY_ERROR = "身份证15位号码都应为数字 ; 18位号码除最后一位外，都应为数字。";
		public static final String LENGTH_ERROR = "身份证号码长度应该为15位或18位。";
		public static final String VALIDATE ="该身份证有效！";
        ...
        public static String validate(String IDStr) throws ParseException {          
            String tipInfo = VALIDATE;// 记录错误信息  
            String Ai = "";  
            // 判断号码的长度 15位或18位  
